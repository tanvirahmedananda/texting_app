...
//                           reverse: true,
//                           itemCount:
//                           chatProv.randomReciversChat[widget.index!].length,
//                           itemBuilder: (context, conindex) {
//                             if (chatProv
//                                 .randomRecivers[widget.index!].username ==
//                                 chatProv
//                                     .randomReciversChat[widget.index!][conindex]
//                                     .username) {
...
//                                     .text,
//                                 time: chatProv
//                                     .randomReciversChat[widget.index!]
//                                 [conindex]
//                                     .time ??
//                                     '',
//                                 image: chatProv
...
//                                 chatProv
//                                     .randomRecivers[widget.index!].phone!,
//                                 TextModel(
